...
{	
	...
	$meta_boxes[] = array(
		...
		//tile(number, meta_id, name); this should be a function you're looking for. 
		'fields' => array(
			array(
				'id'     => $box_prefix  . 'tile_1',
				'name'   => 'massachusetts dealers',
				'type'   => 'group',
			...
			array(
				'id'     => $box_prefix  . 'tile_2',
				'name'   => 'out of state dealers',
				'type'   => 'group',
				// List of child fields
				'fields' => array(
					array(
