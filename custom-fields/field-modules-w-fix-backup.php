	...
	static function create_auction_header_block_group($box_prefix, $group_title){
		$returnArray = array(
				...
				'fields' => array(
					...
					array(
						'name'    => __( 'info position', 'your-prefix' ),
						'id'      => 'radio_'.$box_prefix,
						'type'    => 'radio',
						// Array of 'value' => 'Label' pairs for radio options.
						// Note: the 'value' is stored in meta field, not the 'Label'
						'options' => array(
							'top_left'         => __( 'top left', 'your-prefix' ),
							'top_right'        => __( 'top right', 'your-prefix' ),
							'bottom_left'      => __( 'bottom left', 'your-prefix' ),
							'botttom_right'    => __( 'botttom right', 'your-prefix' ),
						),
					),
					array(
						'name'  => 'button text',
